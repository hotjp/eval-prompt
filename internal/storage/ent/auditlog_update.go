...
func (_u *AuditLogUpdate) SetAssetID(v string) *AuditLogUpdate {
	_u.mutation.SetAssetID(v)
	return _u
}

// SetNillableAssetID sets the "asset_id" field if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableAssetID(v *string) *AuditLogUpdate {
	if v != nil {
		_u.SetAssetID(*v)
	}
	return _u
...
func (_u *AuditLogUpdate) ClearAssetID() *AuditLogUpdate {
...
func (_u *AuditLogUpdate) check() error {
	...
	if v, ok := _u.mutation.AssetID(); ok {
		if err := auditlog.AssetIDValidator(v); err != nil {
			return &ValidationError{Name: "asset_id", err: fmt.Errorf(`ent: validator failed for field "AuditLog.asset_id": %w`, err)}
		}
	}
...
func (_u *AuditLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AssetID(); ok {
		_spec.SetField(auditlog.FieldAssetID, field.TypeString, value)
	}
	if _u.mutation.AssetIDCleared() {
		_spec.ClearField(auditlog.FieldAssetID, field.TypeString)
	}
...
// SetAssetID sets the "asset_id" field.
func (_u *AuditLogUpdateOne) SetAssetID(v string) *AuditLogUpdateOne {
	_u.mutation.SetAssetID(v)
	return _u
}

// SetNillableAssetID sets the "asset_id" field if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableAssetID(v *string) *AuditLogUpdateOne {
	if v != nil {
		_u.SetAssetID(*v)
	}
	return _u
...
// ClearAssetID clears the value of the "asset_id" field.
func (_u *AuditLogUpdateOne) ClearAssetID() *AuditLogUpdateOne {
	_u.mutation.ClearAssetID()
	return _u
}
